...
module.exports = {
  ...
  test_settings: {
    default: {
      ...
      test_runner: {
        ...
        reporterOptions: {
          reportDir: 'reports', // Output directory for the HTML report
          reportName: 'index' // Name of the HTML report file (without extension)
        }
        }
      }
    },
  ...
  usage_analytics: {
    ...
    client_id: '17e72444-46bb-40c8-b508-7424aa2969ff'
  }
